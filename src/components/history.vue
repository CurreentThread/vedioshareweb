            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="col-md-6 col-xs-6 my_content">
                        ...
                        <div v-if="vedios.length!=0">
                              <div class="row each_subs" v-for="(vedio,index) in eachvedios" :key="vedio.vedioid">
                                  <img  class="col-md-offset-1 col-xs-offset-1 col-md-3 col-xs-3 img" :src="vedio.picture" alt="" width="15%" @click="goToDetail(vedio.vedioid)">
                                  ...
                                  <div class="content_body">
                                          <div class="now_episode" v-if="vedio.nowepisode!=0&& vedio.catagory!='电影'">
                                              更新至{{vedio.nowepisode}}集
                                          </div>
                                            <div class="now_episode" v-else>
                                              {{vedio.catagory}}
                                          </div>
                                          <div class="is_view">
                                              <span >
                                                上一次观看第{{historys[index].isview}}集
                                              </span>
                                          </div>
                                          <div class="upd_time">
                                              {{vedio.updtime}}更新
                                      ...
                                      <div class="col-md-offset-4 col-xs-offset-4 col-md-2 col-xs-2" >
                                          <div class="_option">
                                              ...
                                              <ul class="dropdown-menu" style="min-width: 20px;" >
                                                  <li v-if="historys[index].issub==1"><a href="javascript:void(0);" @click="subState(eachSubs,vedio,index)">取消订阅</a></li>
                                                  <li v-else><a href="javascript:void(0);" @click="subState(eachSubs,vedio,index)">订阅</a></li>

                                                  <li><a href="javascript:void(0);" @click="putHandler(vedio)" data-target="#putlist" data-toggle="modal">加入清单</a></li>
